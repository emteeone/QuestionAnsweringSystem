...
namespace QA.Infrastruture.Repository
{
    public class RedisDatabaseRepository : IVectorRepository
    {
                                        ...
                                        IRedisPersistentConnection persistentConnection)
        {
            ...
            _db = new Lazy<IDatabase>(_persistentConnection.GetDatabase());
        }
        ...
        public async Task InsertAsync(string indexName, 
                                    string prefix, 
